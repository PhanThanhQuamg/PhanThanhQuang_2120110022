                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Cập nhập thương hiệu sản phẩm</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $brand->name) }}"
                                        id="name" class="form-control" placeholder="Nhập tên thương hiệu">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="editmetakeybrand" class="form-control" placeholder="Từ khóa tìm kiếm">{{ old('metakey', $brand->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="editmetadescbrand" class="form-control" placeholder="Nhập mô tả">{{ old('metadesc', $brand->metadesc) }}</textarea>
