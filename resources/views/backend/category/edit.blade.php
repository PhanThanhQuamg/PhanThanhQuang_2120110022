                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="edittukhoacate" class="form-control" placeholder="Từ khóa tìm kiếm">{{ old('metakey', $category->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="editmotacate" class="form-control" placeholder="Nhập mô tả">{{ old('metadesc', $category->metadesc) }}</textarea>
