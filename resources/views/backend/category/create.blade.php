                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="tukhoacate" class="form-control" placeholder="Từ khóa tìm kiếm">{{ old('metakey') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="motacate" class="form-control" placeholder="Nhập mô tả">{{ old('metadesc') }}</textarea>
