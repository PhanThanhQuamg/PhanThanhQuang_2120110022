                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakeypage" class="form-control" placeholder="Từ khóa tìm kiếm">{{ old('metakey') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="metadescpage" class="form-control" placeholder="Nhập mô tả">{{ old('metadesc') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="detail" id="detailpage" class="form-control" placeholder="Nhập chi tiết">{{ old('metadesc') }}</textarea>
