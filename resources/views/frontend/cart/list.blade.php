a <div class="table-responsive cart_info">
                ...
                @foreach (Session::get('Cart')->products as $item)
                    ...
                    <tr>
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                                <input id="quanty-item-{{ $item['productInfo']->id }}" class="cart_quantity_input"
                                    type="text" name="quantity" value="{{ $item['soluong'] }}" autocomplete="off"
                                    size="2">
                            </div>
                        </td>
                        <td class="cart_total">
                        ...
                        <td class="cart_delete">
                            ...
                            <a onclick="SaveListItemCart({{ $item['productInfo']->id }});" class="cart_quantity_save"><i
